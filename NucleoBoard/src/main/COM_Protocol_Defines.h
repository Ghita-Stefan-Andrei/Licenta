...
#define ETHERNET_CONNECTION_CHECK_TYPE 0xAE                                             //Type of packet that tells if the board is still connected to ethernet during program execution
...
#define HEADER_BYTE_COUNT_ETH          TYPE_BYTE                                        //Number of bytes before the IP bytes in the data segment
...
#define ETHERNET_DISCONNECTED          0x00                                             //Not connected to eth
#define ETHERNET_CHECK_DATA_BYTE_COUNT (TYPE_BYTE + ETH_STATUS)                         //Number of bytes of the data segment of the packet ETHERNET_CONNECTION_CHECK_TYPE 
#define ETHERNET_CHECK_STATUS_POSITION (ETHERNET_CHECK_DATA_BYTE_COUNT - 1)             //Position of the last data byte in the array of data bytes of ETHERNET_CONNECTION_CHECK_TYPE 
