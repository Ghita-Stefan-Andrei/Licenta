...
#define SLOPE_BYTE_POSITION     LAST_DATA_BYTE_TRIG
...
#define ETHERNET_STATUS_CHECK_T 0xAE
...
#define ETH_STATUS_BYTE_POS     LAST_DATA_BYTE_ETH
#define ETH_CONNECTED           0x01
#define ETH_NOT_CONNECTED       0x00
#define DATA_BYTE_LENGTH_ETH_C  TYPE_BYTE + ETH_STATUS
#define ETH_STATUS_BYTE_POS_C   DATA_BYTE_LENGTH_ETH_C - 1
#define ETH_CONNECTION_OFF      0x02
#define ETH_CONNECTION_UNKNOWN  0x03
